...
.\sshcmds.ps1 -ip "192.168.10.1" -username "admin" -password "admin" -commands "enable,configure terminal,interface eth-0-9,shutdown,exit,exit,exit"
.\sshcmds.ps1 -ip "192.168.10.2" -username "admin" -password "admin" -commands "enable,configure terminal,interface eth-0-9,shutdown,exit,exit,exit"
